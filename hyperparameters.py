...
tf.app.flags.DEFINE_string('version', 'test_01', '''A version number defining the directory to save
...
tf.app.flags.DEFINE_string('ckpt_path', 'logs_test_0/model.ckpt-120', '''Checkpoint
